 ...
 * competing with Saroz Threadz' own madder accent.
 *
    ...
    <div className="border-t border-line bg-canvas">
      <div className="shell flex flex-col gap-3 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
        <a
          ...
          className="group -my-1.5 inline-flex items-center gap-2 py-1.5 font-sans text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-muted transition-colors hover:text-leaf"
        >
        ...
        <nav
          ...
          className="-my-1.5 flex flex-wrap items-center gap-x-4 font-sans text-[0.625rem] font-semibold uppercase tracking-[0.12em] text-muted/70"
        >
          <span className="text-muted/60">Group</span>
          {GROUP_LINKS.map((l) => (
            <a
              key={l.href}
              href={l.href}
